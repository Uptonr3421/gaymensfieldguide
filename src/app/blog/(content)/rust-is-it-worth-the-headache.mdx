...
<SchemaBuilder 
  article={{
    headline: "Rust: Is it Worth the Headache?",
    description: "An honest look at Rust programming language - its memory safety obsession, steep learning curve, and whether it's worth the effort.",
  ...
  breadcrumbs={[
    { name: "Home", item: "/" },
    { name: "Blog", item: "/blog" },
    { name: "Rust", item: "/blog/rust-is-it-worth-the-headache" }
  ]}
/>
