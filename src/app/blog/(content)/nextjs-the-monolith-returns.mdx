...
<SchemaBuilder 
  article={{
    headline: "Next.js: The Monolith Returns",
    description: "How Next.js brought back monolithic architectures and made them cool again after the microservices era.",
  ...
  breadcrumbs={[
    { name: "Home", item: "/" },
    { name: "Blog", item: "/blog" },
    { name: "Next.js", item: "/blog/nextjs-the-monolith-returns" }
  ]}
/>
