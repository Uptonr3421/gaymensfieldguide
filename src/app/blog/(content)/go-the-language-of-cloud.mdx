...
<SchemaBuilder 
  article={{
    headline: "Go: The Language of Cloud Supremacy",
    description: "How Go (Golang) became the dominant programming language for cloud-native development and modern infrastructure.",
  ...
  breadcrumbs={[
    { name: "Home", item: "/" },
    { name: "Blog", item: "/blog" },
    { name: "Go Language", item: "/blog/go-the-language-of-cloud" }
  ]}
/>
