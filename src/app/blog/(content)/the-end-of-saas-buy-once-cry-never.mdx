...
<SchemaBuilder 
  article={{
    headline: "The End of SaaS: Buy Once, Cry Never",
    description: "SaaS has dominated for years, but the tide is turning toward buy-once software and local alternatives. Is subscription fatigue real?",
  ...
  breadcrumbs={[
    { name: "Home", item: "/" },
    { name: "Blog", item: "/blog" },
    { name: "End of SaaS", item: "/blog/the-end-of-saas-buy-once-cry-never" }
  ]}
/>
